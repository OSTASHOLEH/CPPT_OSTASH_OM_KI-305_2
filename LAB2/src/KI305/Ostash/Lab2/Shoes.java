...
public class Shoes {
     ...
     * @param newColor defines new color of a shoe
     */
    ...
    /**
     * Method for changing color of laces
     * @param newLacesColor defines new color of laces
     */
    ...
    /**
     * Method for changing sole color
     * @param newSoleColor defines new sole color
     */
...
/**
 * <code>class Color</code> represents color of shoes
 * @author Oleh Ostash
 * @version 1.0
 */
class Color{
    ...
    /**
     * Constructor with parameters
     * @param col is used to set color of a shoe
     */
    ...
    /**
     * Setter
     * @param col sets color of a shoe
     */
...
/**
 * <code>class Material</code> represents material of shoes
 * @author Oleh Ostash
 * @version 1.0
 */
class Material{
    ...
    /**
     * Constructor with parameters
     * @param mat is used to set <code>material</code> of a shoe
     */
    ...
    /**
     * Setter
     * @param mat sets <code>material</code> of a shoe
     */
...
/**
 * <code>class Laces</code> represents laces of shoes
 * @author Oleh Ostash
 */
class Laces{
    private String color;
    ...
    /**
     * Constructor with parameters
     * @param col is used to set <code>color</code> of a shoe
     * @param un is used to set <code>unlaced</code> of a shoe
     */
    ...
    /**
     * Getter
     * @return <code>color</code> of a shoe
     */
    public String getColor(){
        return color;
    }
...
/**
 * <code>class Sole</code> represents sole of shoes
 * @author Oleh Ostash
 * @version 1.0
 */
class Sole{
    ...
    /**
     * Constructor with parameters
     * @param col is used to set <code>color</code> of a sole
     */
    ...
    /**
     * Setter
     * @param col sets color of a sole
     */
    public void setColor(String col){
        color=col;
    }
...
/**
 * <code>class Size</code> represents size of shoes
 * @author Oleh Ostash
 * @version 1.0
 */
class Size{
